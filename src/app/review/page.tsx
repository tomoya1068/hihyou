...
import { getReviewsByUrl, submitReview, type Platform, type Review, type ReviewSummary } from "./actions";
...
type Parsed = { productId: string; platform: Platform } | null;

function parseReviewUrl(url: string): Parsed {
...
export default function ReviewPage() {
  ...
  const [summary, setSummary] = useState<ReviewSummary>({ average: null, median: null, total: 0 });
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_#1f2f46_0%,_#0a0f1a_35%,_#05070d_100%)] text-slate-100">
